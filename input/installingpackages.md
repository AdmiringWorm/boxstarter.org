...
For each machine that Boxstarter installs (see [below](installingpackages#RemoteInstallations) for remote installation details) an object is emitted to the PowerShell pipeline containing details about the install:
...
![Screen shot of Boxstarter installing a Minecraft Server (bukkit) on a AWS EC2 instance](/assets/images/amazon.png)
